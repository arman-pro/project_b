                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">{{ $totalPendingOrders ?? 0 }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">{{ $totalCanceledOrders ?? 0 }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">{{ $totalProcessingOrders ?? 0 }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-12">
                            <div class="info-box">
                                <span class="info-box-icon bg-success"><i class="far fa-star"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Compelete Orders</span>
                                    <span class="info-box-number">{{ $totalCompeleteOrders ?? 0 }}</span>
                                </div>
                            </div>
                        </div>
