        ...
        <div class="card-body">
          <form action="{{route("admin.blogs.store")}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input 
                  ...
                  class="form-control @error('short_description') is-invalid @enderror" value="{{old('short_description')}}" required/>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <textarea name="description" id="description" class="form-control" placeholder="Description" cols="30" rows="10">{!!html_entity_decode(old('description'))!!}</textarea>
                @error('description')
                  <div class="invalid-feedback">{{$message }}</div>  
                @enderror
              </div>                                   
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input 
                  ...
                  class="form-control @error('meta_description') is-invalid @enderror" value="{{old('meta_description')}}"/>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input 
                  ...
                  class="form-control @error('img_alt_text') is-invalid @enderror" value="{{old('img_alt_text')}}"/>
                @error('img_alt_text')
                  <div class="invalid-feedback">{{$message }}</div>  
                @enderror
              </div>                                   
            ...
            {{-- meta robots tags --}}
            <div class="form-group row">
              <label for="meta_robots_tags" class="col-sm-3 col-form-label text-right">Meta Robot Tags</label>
              <div class="col-sm-9">
                <input 
                  type="text" name="meta_robots_tags" id="meta_robots_tags" 
                  class="form-control @error('meta_robots_tags') is-invalid @enderror" value="{{old('meta_robots_tags')}}"/>
