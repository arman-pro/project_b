                    ...
                    <div class="card-body">
                        <div class="form-col">
                                ...
                                <div class="col-sm-9">
                                    <select name="job_type" id="job_type"
                                        ...
                                        @foreach (get_order_job_types() as $job_type)
                                            <option @if (old('job_type') == $job_type) selected @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="image_qty" id="image_qty"
                                        class="form-control @error('image_qty') is-invalid @enderror"
                                        value="{{ old('image_qty') }}" placeholder="Image Quantity" required />
                                    @error('image_qty')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="image_destination" class="col-sm-3 col-form-label text-right">Image
                                    Destination*</label>
                                <div class="col-sm-9">
                                    <input type="text" name="image_destination" value="{{ old('image_destination') }}"
                                        id="image_destination"
                                        class="form-control @error('image_destination') is-invalid @enderror"
                                        placeholder="Image Destination (Links)" required />
                            ...
                            <div class="form-group row">
                                <label for="job_description" class="col-sm-3 col-form-label text-right">Job
                                    Description*</label>
                                <div class="col-sm-9">
                                    <textarea name="job_description" id="job_description" cols="30" rows="4"
                                        class="form-control @error('job_description') is-invalid @enderror" placeholder="Job Description">{{ old('job_description') }}</textarea>
